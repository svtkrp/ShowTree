...
class HeapButtons extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {fieldDisabled: false, randomDisabled: false, setJsonDisabled: false, jsonValue: jsonStr, jsonOpen: false,
      ...
      <div>
        <Card style={{ marginBottom: 12 }} elevation={3}>
          ...
          <CardActions> 
            ...
            <MyButton name="Удалить минимальный узел" onClick={() => this.deleteMin()} disabled={this.state.deleteDisabled} />
